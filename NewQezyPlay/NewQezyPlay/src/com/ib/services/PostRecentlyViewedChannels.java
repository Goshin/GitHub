...
public class PostRecentlyViewedChannels extends AsyncTask<FilteredParamsForAsyncTask, String, String> {
	...
	public PostRecentlyViewedChannels(Context a ) {
		 context = a;
	...
	protected  String doInBackground(FilteredParamsForAsyncTask... params) {
		String result = null; 	
		 ...
		 Log.e(TAG, " ************  added  for most recently viewed channel id  **********        "+ChannelId);
		 Log.e(TAG, " ************  added  for most recently viewed  unique id  **********        "+UniqueDeviceId);
		...
		try {
			...
			HttpPost httpPost = new HttpPost(Constants.SERVER_URL+"QezyPlay/api/web/MostRecentlyViewed.json");
				...
				Log.e(TAG, "  Response  for recently Viewed"+result);
